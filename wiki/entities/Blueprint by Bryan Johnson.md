...
type: entity
tags: [blueprint, bryan-johnson, longevity, supplements, functional-coffee, white-space, transparency, COA, community-flywheel, dont-die, performance-cafe, benchmark, matcha, longevity-mix, pricing, kaffee, protokoll]
sources: ["raw/Business/PerformanceCafe/research/04_marktanalyse.md", "raw/Business/PerformanceCafe/CLAUDE.md"]
created: 2026-06-14
updated: 2026-06-14
summary: Bryan Johnsons kommerzielles Longevity-Supplement-Brand (blueprint.bryanjohnson.com) — verkauft Longevity Mix (~€1,50/Portion), Matcha, Super Shrooms, Creatin, Omega-3, Essentials; KEIN Kaffeeprodukt; Community-Flywheel über die Don't Die-Bewegung; COA-Transparenz; ~2M X/Twitter-Follower; primärer Benchmark und Quelle der White Space für Performance Coffee Brand
---
...
| **Don't Die App / Protokoll-Dokumentation** | Johnsons vollständiges Protokoll online — Blutwerte, Schlafscores, biologisches Alter öffentlich nachverfolgbar |
...
- **Blueprint Protocol Marketplace:** Drittanbieter-Produkte, die „Blueprint-kompatibel" sind, können gelistet werden; Konditionen nicht öffentlich dokumentiert

> ⚠️ **Strategische Chance:** Performance Café könnte potenziell auf dem Blueprint Protocol Marketplace als Blueprint-kompatibles Kaffeeprodukt gelistet werden. Direktanfrage an blueprint.bryanjohnson.com empfohlen.
...
2. **Stimmungsinstabilität:** Kaffee erzeugt einen „Achterbahn"-Effekt — unvereinbar mit stabilem emotionalen Zustand
3. **Abhängigkeitsbildung:** Nach einer Woche braucht er Kaffee nur, um sich „normal" zu fühlen
4. **Individuelle Biomarker-Reaktion:** Ausdrücklich eine persönliche Reaktion, nicht generelle Kaffee-Ablehnung

**Wichtige Nuancierung:** Johnson argumentiert NICHT generell gegen Kaffee. Er hat Kaffeeforschung positiv zitiert (Trigonellin, Chlorogensäure als NMN-Vorläufer) und gesagt: *„you don't drink coffee for the caffeine, you drink it for the gut flora effects."* Seine Community trinkt Kaffee — er verkauft nur keinen.
...
| Johnsons positive Kaffeeforschungs-Zitate | Legitimation für „Longevity Coffee"-Framing, das zur Blueprint-Philosophie passt |

**Positionierung:** *„Precision-dosed Longevity Stack + Premium-Kaffee = Blueprint-kompatibles Produkt, das Bryan Johnson selbst nicht herstellt."*
...
| Vergleich | Wert |
|---|---|
| Blueprint Longevity Mix | ~€1,50/Portion |
| Performance Café (Abo-Empfehlung) | €3,49/Portion |
| Multiplikator | 2,3× Blueprint |
| Framing | „Blueprint-kompatibel + Kaffee" |
| Purovitalis NMN + Blueprint Mix | ~€105/Monat |
| Performance Café 30-Pack Abo | 104,70 €/Monat |

Performance Café bietet Kunden den Longevity Stack **und** Qualitätskaffee — zwei Produkte in einem, zum Preis von einem.
...
- Blueprints COA-Transparenz setzt die Qualitätslatte, die Performance Café erfüllen muss
- Blueprints Philosophie „every ingredient earned its place" definiert den Zutatenselektion-Standard
- Blueprints Preisgestaltung verankert den Einstiegspunkt der Kategorie
...
- [[Functional Coffee White Space]] — Marktchancen-Konzept
- [[Performance Café Pricing Strategy]] — Preisgestaltung am Blueprint-Benchmark ausgerichtet
- [[Performance Cafe Marktanalyse Source Detail]] — Quelldokument
- [[Timeline Nutrition]] — separater Longevity-Wettbewerber
- [[Tru Niagen]] — separater Longevity-Wettbewerber
