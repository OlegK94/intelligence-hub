...
type: source
tags: [finance, master-prompt, audit, insolvency, tax, consolidated-analysis, oleg-kober, wagglz-gmbh, ok-capital-ug, private-finances, 4x-roles]
sources: ["raw/raw/Privat/Finanzen/Master Prompt – Gesamtanalyse.md"]
created: 2026-06-10
updated: 2026-06-14
summary: Vollständiger Finanz-Audit-Prompt für integrierte Analyse Privat + Wagglz GmbH + OK Capital UG; 4x-Rollen-Framework (FD Finance Director, ST Steuerberater, IA Insolvenzanalyst, US Unternehmensstratege); 5 kritische Fragen (Überschuldung/Antragspflicht/Gesamtschaden/Steuerliche Verluste/Exit-Strategie); 6 Deliverables (Ampel-Dashboard ROT/GELB/GRÜN, konsolidierte Bilanz, Steuer-To-Do, Sofortmaßnahmen, Strategische Optionen, Gesamtstrategie)
---
...
1. Gesamten Prompt-Block kopieren
...
- [[00 Finanz-Übersicht]] — Private Finanzübersicht Oleg Kober
- [[Insolvency Risk Assessment]] — Rahmenwerk §17/19 InsO
- [[Rehabilitation Plan]] — 3-Phasen Finanzstabilisierung
- [[Wagglz GmbH]], [[OK Capital UG]] — analysierte Gesellschaften
- [[Oleg Personal Context]] — Geschäftsführer und Privatperson
- [[SP STB]] — Steuerberater
- [[Verlustvortrag]] — Wagglz ~€150k (steuerliche Implikation)
